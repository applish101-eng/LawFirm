      ...
      >
        <Container className="flex flex-col space-y-10 md:space-y-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-stretch">
            ...
            >
              <div className="space-y-4">
                <div ref={titleRef} className="flex flex-col space-y-1">
                  <span className="text-xs md:text-sm font-medium tracking-wide text-neutral-500  font-primary">
                    Contacts
                  </span>
            ...
            <div
              ref={rightContentRef}
              className="lg:col-span-6 w-full h-full overflow-hidden rounded-sm shadow-xs"
            >
              <img
                src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&q=80&w=1600"
                alt="Lady Justice statue representing law and fairness"
